...
```{r}
density_year_all <- ggplot(grant_ec, aes(x = submit_year_mon, y = time)) +geom_vline(xintercept = as.yearmon('May 2019'), linetype="dashed", 
             color = "black", size=1)+
...
print(density_year_all)
```

```{r}
density_year_infra_haryana <- ggplot(filter(grant_ec,state1=='Rajasthan'), aes(x = submit_year_mon, y = time)) +geom_vline(xintercept = as.yearmon('Oct 2019'), linetype="dashed", 
             color = "black", size=1)+
  geom_point(fill = "skyblue", color = "darkblue", alpha = 0.5) + scale_x_yearmon()+
...
```{r}
density_year_infra_up <- ggplot(filter(grant_ec,state1=='Haryana'), aes(x = submit_year_mon, y = time)) +geom_vline(xintercept = as.yearmon('March 2017'), linetype="dashed", 
             color = "black", size=1)+
  geom_point(fill = "skyblue", color = "darkblue", alpha = 0.5) + scale_x_yearmon()+
